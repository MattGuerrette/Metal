...
void Triangle::init()
{
    ...
    NSString* libraryPath = [[[NSBundle mainBundle] resourcePath] stringByAppendingPathComponent:@"shader.metallib"];
    library_ = [device_ newLibraryWithFile:libraryPath error:nil];
